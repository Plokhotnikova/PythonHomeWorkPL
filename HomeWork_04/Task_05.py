...
def analys_monom(st):
    ...
    ii = l - 1  # индекс
    while ii >= 0:
        if sq_monom(st[ii]) != -1 and sq_monom(st[ii]) == i:
...
lst1 = analys_monom(st1)
lst2 = analys_monom(st2)
ll = len(lst1)
...
write_ToFile("file34_res.txt", monom_create(lst_new))
